 ...
 */
public class ResponseSetupGeneralData extends AbstractResponseData {

	public static final byte MESSAGE_ID = (byte) 0x14;

	public ResponseSetupGeneralData(byte[] buffer) {
		super(buffer, "general data");
	}
}
